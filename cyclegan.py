...
class ResNetBlock(nn.Module):
    def __init__(self, dim):
        ...
        self.conv_block = self.build_cov_block(dim)
...
if __name__ == '__main__':
    ...
    model_path = '/Users/wenxu/PycharmProjects/deep_learning_with_pytorch/data/p1ch2/horse2zebra_0.4.0.pth'
    model_data = torch.load(model_path)
    netG.load_state_dict(model_data, strict=False)
    netG.eval()

    preprocess = transforms.Compose([transforms.Resize(256), transforms.ToTensor()])
    img = Image.open('/Users/wenxu/PycharmProjects/deep_learning_with_pytorch/data/p1ch2/horse.jpg')
